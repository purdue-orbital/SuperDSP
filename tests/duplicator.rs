...
pub fn test_unduplicator(){
    ...
    assert_eq!(unduplicator(test.as_slice(), 2), expected);
}
...
pub fn test_duplicator_full_cycle() {
    ...
    let out = unduplicator(out.as_slice(), 2);
...
pub fn test_unduplicator_i8(){
    ...
    assert_eq!(unduplicator_i8(test.as_slice(), 2), expected);
}
...
pub fn test_duplicator_full_cycle_i8() {
    ...
    let out = unduplicator_i8(out.as_slice(), 2);
...
pub fn test_unduplicator_u8(){
    ...
    assert_eq!(unduplicator_u8(test.as_slice(), 2), expected);
}
...
pub fn test_duplicator_full_cycle_u8() {
    ...
    let out = unduplicator_u8(out.as_slice(), 2);
...
pub fn test_unduplicator_complex(){
    ...
    assert_eq!(unduplicator_complex(test.as_slice(), 2), expected);
}
...
pub fn test_duplicator_full_cycle_complex() {
    ...
    let out = unduplicator_complex(out.as_slice(), 2);
