...
#[test]
pub fn fsk_byte_1() {
    let test = DATA.instance.fsk(DATA.signal_1byte.clone());
...
#[test]
pub fn fsk_byte_2() {
    let test = DATA.instance.fsk(DATA.signal_2bytes.clone());
...
#[test]
pub fn fsk_byte_4() {
    let test = DATA.instance.fsk(DATA.signal_4bytes.clone());
...
#[test]
pub fn fsk_byte_8() {
    let test = DATA.instance.fsk(DATA.signal_8bytes.clone());
...
#[test]
pub fn fsk_byte_16() {
    let test = DATA.instance.fsk(DATA.signal_16bytes.clone());
...
#[test]
pub fn fsk_byte_32() {
    let test = DATA.instance.fsk(DATA.signal_32bytes.clone());
...
#[test]
pub fn fsk_byte_64() {
    let test = DATA.instance.fsk(DATA.signal_64bytes.clone());
...
#[test]
pub fn fsk_byte_128() {
    let test = DATA.instance.fsk(DATA.signal_128bytes.clone());
...
#[test]
pub fn fsk_byte_256() {
    let test = DATA.instance.fsk(DATA.signal_256bytes.clone());
...
#[test]
pub fn fsk_byte_512() {
    let test = DATA.instance.fsk(DATA.signal_512bytes.clone());
...
pub fn fsk_byte_1024() {
    let test = DATA.instance.fsk(DATA.signal_1024bytes.clone());
...
pub fn fsk_byte_2048() {
    let test = DATA.instance.fsk(DATA.signal_2048bytes.clone());
