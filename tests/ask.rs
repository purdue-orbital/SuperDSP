...
#[test]
pub fn ask_byte_1() {
    let test = DATA.instance.ask(DATA.signal_1byte.as_slice());
...
#[test]
pub fn ask_byte_2() {
    let test = DATA.instance.ask(DATA.signal_2bytes.as_slice());
...
#[test]
pub fn ask_byte_4() {
    let test = DATA.instance.ask(DATA.signal_4bytes.as_slice());
...
#[test]
pub fn ask_byte_8() {
    let test = DATA.instance.ask(DATA.signal_8bytes.as_slice());
...
#[test]
pub fn ask_byte_16() {
    let test = DATA.instance.ask(DATA.signal_16bytes.as_slice());
...
#[test]
pub fn ask_byte_32() {
    let test = DATA.instance.ask(DATA.signal_32bytes.as_slice());
...
#[test]
pub fn ask_byte_64() {
    let test = DATA.instance.ask(DATA.signal_64bytes.as_slice());
...
#[test]
pub fn ask_byte_128() {
    let test = DATA.instance.ask(DATA.signal_128bytes.as_slice());
...
#[test]
pub fn ask_byte_256() {
    let test = DATA.instance.ask(DATA.signal_256bytes.as_slice());
...
#[test]
pub fn ask_byte_512() {
    let test = DATA.instance.ask(DATA.signal_512bytes.as_slice());
...
pub fn ask_byte_1024() {
    let test = DATA.instance.ask(DATA.signal_1024bytes.as_slice());
...
pub fn ask_byte_2048() {
    let test = DATA.instance.ask(DATA.signal_2048bytes.as_slice());
...
pub fn ask_partial_test() {
    ...
    let test = DATA.instance.ask(&DATA.signal_2bytes[samples_per_symbol * 9..])[0];
