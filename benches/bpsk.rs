...
pub fn bpsk_byte_1() {
    DATA.instance.bpsk(DATA.signal_1byte.as_slice());
}
...
pub fn bpsk_byte_4() {
    DATA.instance.bpsk(DATA.signal_4bytes.as_slice());
}
...
pub fn bpsk_byte_16() {
    DATA.instance.bpsk(DATA.signal_16bytes.as_slice());
}


pub fn bpsk_byte_32() {
    DATA.instance.bpsk(DATA.signal_32bytes.as_slice());
}


pub fn bpsk_byte_64() {
    DATA.instance.bpsk(DATA.signal_64bytes.as_slice());
}
...
pub fn bpsk_byte_256() {
    DATA.instance.bpsk(DATA.signal_256bytes.as_slice());
}


pub fn bpsk_byte_512() {
    DATA.instance.bpsk(DATA.signal_512bytes.as_slice());
}


pub fn bpsk_byte_1024() {
    DATA.instance.bpsk(DATA.signal_1024bytes.as_slice());
}


pub fn bpsk_byte_2048() {
    DATA.instance.bpsk(DATA.signal_2048bytes.as_slice());
}
