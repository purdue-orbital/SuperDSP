...
pub fn flat_top_window<const N: usize>(offset:usize) -> [f32; N] {
    ...
    for i in 0..N{
      let n = (i as f32) - (offset as f32);
       filter[i] = A_0 - A_1 * libm::cosf((2.0 * core::f32::consts::PI * n as f32)/N as f32) + A_2 * libm::cosf((4.0 * core::f32::consts::PI * n as f32)/N as f32) - A_3 * libm::cosf((6.0 * core::f32::consts::PI * n as f32)/N as f32) + A_4 * libm::cosf((8.0 * core::f32::consts::PI * n as f32)/N as f32);
    }
   filter
}